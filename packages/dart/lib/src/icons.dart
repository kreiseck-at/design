...
abstract final class KdIcons {
  ...
  static const KdIconData settingsFilled = KdIconData(fill: [KdMove(4, 6), KdLine(5, 6), KdLine(5, 8), KdLine(4, 8), KdClose(), KdMove(13, 6), KdLine(20, 6), KdLine(20, 8), KdLine(13, 8), KdClose(), KdMove(4, 16), KdLine(11, 16), KdLine(11, 18), KdLine(4, 18), KdClose(), KdMove(19, 16), KdLine(20, 16), KdLine(20, 18), KdLine(19, 18), KdClose(), KdMove(11.5, 7), KdCubic(11.5, 8.4, 10.4, 9.5, 9, 9.5), KdCubic(7.6, 9.5, 6.5, 8.4, 6.5, 7), KdCubic(6.5, 5.6, 7.6, 4.5, 9, 4.5), KdCubic(10.4, 4.5, 11.5, 5.6, 11.5, 7), KdClose(), KdMove(17.5, 17), KdCubic(17.5, 18.4, 16.4, 19.5, 15, 19.5), KdCubic(13.6, 19.5, 12.5, 18.4, 12.5, 17), KdCubic(12.5, 15.6, 13.6, 14.5, 15, 14.5), KdCubic(16.4, 14.5, 17.5, 15.6, 17.5, 17), KdClose()]);
  ...
  static const KdIconData handCoins = KdIconData(stroke: [KdMove(4, 16), KdCubic(6, 15, 8, 15, 10, 16), KdLine(15, 16), KdCubic(15.828, 16, 16.5, 16.672, 16.5, 17.5), KdCubic(16.5, 18.328, 15.828, 19, 15, 19), KdLine(11, 19), KdMove(8, 12), KdCubic(10, 11, 12, 11, 14, 12), KdMove(20.5, 6.5), KdCubic(20.5, 8.157, 19.157, 9.5, 17.5, 9.5), KdCubic(15.843, 9.5, 14.5, 8.157, 14.5, 6.5), KdCubic(14.5, 4.843, 15.843, 3.5, 17.5, 3.5), KdCubic(19.157, 3.5, 20.5, 4.843, 20.5, 6.5), KdClose(), KdMove(17.5, 5), KdLine(17.5, 8)]);
  ...
  static const KdIconData circleFilled = KdIconData(fill: [KdMove(21, 12), KdCubic(21, 17, 17, 21, 12, 21), KdCubic(7, 21, 3, 17, 3, 12), KdCubic(3, 7, 7, 3, 12, 3), KdCubic(17, 3, 21, 7, 21, 12), KdClose()]);
  ...
  static const KdIconData calendarClock = KdIconData(stroke: [KdMove(21, 10), KdLine(21, 7.5), KdCubic(21, 6.119, 19.881, 5, 18.5, 5), KdLine(5.5, 5), KdCubic(4.119, 5, 3, 6.119, 3, 7.5), KdLine(3, 18.5), KdCubic(3, 19.881, 4.119, 21, 5.5, 21), KdLine(10, 21), KdMove(3, 10), KdLine(21, 10), KdMove(8, 3), KdLine(8, 7), KdMove(16, 3), KdLine(16, 7), KdMove(21, 17.5), KdCubic(21, 19.709, 19.209, 21.5, 17, 21.5), KdCubic(14.791, 21.5, 13, 19.709, 13, 17.5), KdCubic(13, 15.291, 14.791, 13.5, 17, 13.5), KdCubic(19.209, 13.5, 21, 15.291, 21, 17.5), KdClose(), KdMove(17, 15.5), KdLine(17, 17.5), KdLine(18.5, 19)]);
  ...
  static const KdIconData userFilled = KdIconData(fill: [KdMove(8, 8), KdCubic(8, 5.791, 9.791, 4, 12, 4), KdCubic(14.209, 4, 16, 5.791, 16, 8), KdCubic(16, 10.209, 14.209, 12, 12, 12), KdCubic(9.791, 12, 8, 10.209, 8, 8), KdClose(), KdMove(4, 21), KdCubic(4, 16.582, 7.582, 13, 12, 13), KdCubic(16.418, 13, 20, 16.582, 20, 21), KdClose()]);
